...
export const Projects = () => {
	return (
		<section
			id='projects'
			className='py-[4rem] flex flex-col gap-[2rem]'
		>
			...
			<div className='grid gap-[2rem] min-lg:grid-cols-3 min-[700px]:grid-cols-2 m-auto'>
				...
				/>
				<ProjectsDemo
					src='/images/agricon.jpeg'
					projectName='AGRICON'
					description='an innovative platform purposed to transform agriculture by connecting farmers to nearby storage facilities. Our mission is to reduce post-harvest losses and boost efficiency across the agricultural value chain.'
					languages='REACT, TAILWIND, EXPRESS, MONGODB'
					ghLink='https://github.com/InternPulse/agricon-frontend.git'
					webLink='https://agricon.com.ng/'
				/>
			</div>
		</section>
	);
...
const ProjectsDemo = ({
	...
	return (
		<div
			className={`${
				isDark
					? 'text-black bg-blue-100 hover:shadow-gray-400'
					: 'text-white bg-gray-600 hover:shadow-gray-500'
			} grid rounded-lg cursor-pointer shadow-md duration-500 max-w-[22rem]`}
		>
			<img
				src={src}
				alt={src}
			...
			<div className='p-[1rem] flex flex-col gap-[1rem]'>
				...
				<div className='flex gap-2.5'>
					...
					>
						<CgWebsite className='text-[2rem] cursor-pointer' />
					</a>
				</div>
			</div>
		</div>
